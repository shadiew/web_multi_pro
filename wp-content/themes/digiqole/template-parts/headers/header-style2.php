                    ...
                    ?>
                     <?php echo  digiqole_text_logo()?'<h1 class="logo-title">':''; ?> 
                        <a class="logo" href="<?php echo esc_url(home_url('/')); ?>">
                           ...
                           <?php else: ?>
                              <img width="220" height="33" class="img-fluid logo-dark" src="<?php echo esc_url($digiqole_logo_url); ?>" alt="<?php echo get_bloginfo('name') ?>">
                              <img width="220" height="33" class="img-fluid logo-light" src="<?php echo esc_url($digiqole_light_logo_url); ?>" alt="<?php echo get_bloginfo('name') ?>">
                           <?php endif; ?>
