 ...
 * twitter feed widget
 */
class Digiqole_Twitter_Feed extends WP_Widget {

    function __construct() {
        $widget_opt = array(
            'classname'		 => 'digiqole-twitter-feed',
            'description'	 => esc_html__('Digiqole twitter feed','digiqole-essential')
        );

        parent::__construct( 'xs-twitter-feed', esc_html__( 'Digiqole twitter feed', 'digiqole-essential' ), $widget_opt );
    }
    ...
    function widget( $args, $instance ) {
        ...
        $username			 = '';
        $loading_text = esc_html__('Loading!','digiqole-essential');
        ...
        wp_register_script('twitter_username', DIGIQOLE_SCRIPTS . '/twitter-username.js', array());
    ...
    function form( $instance ) {
        if ( isset( $instance[ 'title' ] ) ) {
            ...
            $title = esc_html__( 'Twitter feed', 'digiqole-essential' );
        }
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'username' ) ); ?>"><?php esc_html_e( 'Username:', 'digiqole-essential' ); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'loading_text' ) ); ?>"><?php esc_html_e( 'Loading text:', 'digiqole-essential' ); ?></label>
