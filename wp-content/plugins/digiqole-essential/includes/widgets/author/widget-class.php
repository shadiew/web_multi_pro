...
class Digiqole_Author extends WP_Widget
{
    /**
     * Constructor
     **/
    public function __construct()
    {
        $widget_ops = array(
            ...
            'description' => esc_html__('Digiqole Author','digiqole-essential'),
        );
        parent::__construct( 'pu_media_upload', 'Digiqole Author', $widget_ops );
    ...
    public function widget( $args, $instance )
    {
      ...
      <div class="post-content">
         ...
         <?php   $social_links = digiqole_option('general_social_links',[]); ?>
         ...
         <div class="authors-social">
              <?php
                $class1 = '';
                 ...
                 $class1 = 'ts-icon ts-icon-' . str_replace('fa fa-', '', $sl['icon_class']);
              ?>
               <a href="<?php echo esc_url($sl['url']); ?>" class="<?php echo esc_attr($class); ?>">
                  <i class="<?php echo esc_attr($class1); ?>"></i>
               </a>
             <?php endforeach; ?>
